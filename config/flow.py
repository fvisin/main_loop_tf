...
gflags.DEFINE_string('checkpoints_dir', '', 'The path where the model '
...
gflags.DEFINE_integer('min_epochs', 0, 'The minimum number of epochs '
                      'before early stopping is possible', lower_bound=0)
gflags.DEFINE_integer('max_epochs', 0, 'The maximum number of epochs',
                      lower_bound=0)
