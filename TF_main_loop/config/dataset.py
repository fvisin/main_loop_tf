...
gflags.DEFINE_list('crop_size', None, 'The training crop-size')
gflags.DEFINE_string('dataset', None, 'The dataset')
gflags.DEFINE_bool('of', False, 'Whether to have the optical flow as an input')
gflags.DEFINE_integer('seq_length', 0, 'The length of the sequence, in '
                      'case the input is a video', lower_bound=0)
gflags.DEFINE_integer('seq_per_subset', 0, 'Limit the number of sequences per '
                      'subset (i.e., video or prefix or directory). If zero '
                      'all the possible sequences will be returned',
                      lower_bound=0)
gflags.DEFINE_integer('overlap', 0, 'The overlap (in number of frames) '
